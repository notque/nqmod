...
function OnToggleNotifications()
	if IsPartialScreenOpen("NotificationLog") then
		LuaEvents.PartialScreenHooks_CloseNotificationLog();
	else		
		if IsPartialScreenOpen() then				-- Only play open sound if no partial screen is open.
			LuaEvents.PartialScreenHooks_CloseAllExcept("NotificationLog");
		end		
...
-- ===========================================================================
function NewMessage(bNew:boolean)
	if (bNew) then
		Controls.NoteImg:SetColor(0xFF00FF00);
		Controls.NoteLogButton:SetColor(0xFF00FF00);
	else
		Controls.NoteImg:SetColor(0xFF7FB6DA);
		Controls.NoteLogButton:SetColor(0xFFFFFFFF);
	end
end
-- ===========================================================================
function Initialize()
	...
	Controls.NoteLogButton:RegisterCallback( Mouse.eLClick,	OnToggleNotifications );
	Controls.NoteLogButton:RegisterCallback( Mouse.eMouseEnter, function() UI.PlaySound("Main_Menu_Mouse_Over"); end);
	...
	LuaEvents.NewNoteLogMsg.Add(NewMessage);
	OnTurnBegin();
end
Initialize();
