...
function SetBeliefIcon(targetControl:table, beliefType:string, iconSize:number)
	...
	if (beliefType == 'BELIEF_ROYAL_HOSPITALITY') then
		beliefType = 'BELIEF_DANCE_OF_THE_AURORA';
	end

	if (beliefType == 'BELIEF_INIT_RITES') then
		beliefType = 'BELIEF_ORAL_TRADITION';
	end

	if (beliefType == 'BELIEF_GOD_OF_THE_OPEN_SEA') then
		beliefType = 'BELIEF_GOD_OF_THE_SEA';
	end

	if (beliefType == 'BELIEF_FOREST_FAITH') or (beliefType == 'BELIEF_GOD_OF_THE_OPEN_SEA') then
			beliefType = 'BELIEF_DANCE_OF_THE_AURORA';
	end
