...
-- update stone circles to +3 faith
...
--INSERT INTO Types (Type, Kind) VALUES ('MODIFIER_PLAYER_CAPITAL_ADJUST_BUILDING_HOUSING', 'KIND_MODIFIER');
--INSERT INTO DynamicModifiers (ModifierType, CollectionType, EffectType) VALUES ('MODIFIER_PLAYER_CAPITAL_ADJUST_BUILDING_HOUSING', 'COLLECTION_PLAYER_CAPITAL_CITY', 'EFFECT_ADJUST_BUILDING_HOUSING');

INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES ('BELIEF_ROYAL_HOSPITALITY_ADDHOUSING','MODIFIER_ALL_CITIES_ATTACH_MODIFIER', 'CITY_HAS_PALACE_FOLLOWS_PANTHEON');
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES ('BELIEF_ROYAL_HOSPITALITY_ADDHOUSING_MODIFIER','MODIFIER_SINGLE_CITY_ADJUST_BUILDING_HOUSING');
...
INSERT INTO Modifiers (ModifierId, ModifierType, SubjectRequirementSetId) VALUES ('BELIEF_ROYAL_HOSPITALITY_ADDAMENITES','MODIFIER_ALL_CITIES_ATTACH_MODIFIER', 'CITY_HAS_PALACE_FOLLOWS_PANTHEON');
INSERT INTO Modifiers (ModifierId, ModifierType) VALUES ('BELIEF_ROYAL_HOSPITALITY_ADDAMENITES_MODIFIER','MODIFIER_SINGLE_CITY_ADJUST_CITY_AMENITIES_FROM_RELIGION');
...
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES ('CITY_HAS_PALACE_FOLLOWS_PANTHEON', 'REQUIRES_CITY_HAS_PALACE');
INSERT INTO RequirementSetRequirements (RequirementSetId, RequirementId) VALUES ('CITY_HAS_PALACE_FOLLOWS_PANTHEON', 'REQUIRES_CITY_FOLLOWS_PANTHEON');

INSERT INTO RequirementArguments (RequirementId, Name, Value) VALUES ('REQUIRES_CITY_HAS_PALACE', 'BuildingType', 'BUILDING_PALACE');
INSERT INTO RequirementSets (RequirementSetId, RequirementSetType) VALUES ('CITY_HAS_PALACE_FOLLOWS_PANTHEON', 'REQUIREMENTSET_TEST_ALL');

INSERT INTO Requirements (RequirementId, RequirementType) VALUES ('CITY_HAS_PALACE_FOLLOWS_PANTHEON', 'REQUIREMENT_CITY_FOLLOWS_PANTHEON');
